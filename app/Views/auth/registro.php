    ...
    <div class="auth-card card">
        ...
        <div class="auth-header">
            <div class="auth-logo-container">
                <img src="/financas/public/images/logo.png" alt="PREDITIV.IA" class="logo-img">
            </div>
        ...
        <form action="/financas/auth/registro" method="POST" class="auth-form">
            ...
            <div class="form-group">
                <div class="input-with-icon">
                    ...
                    <input type="password" name="senha" class="form-control" placeholder="Crie uma Senha" required autocomplete="new-password">
                </div>
            </div>
            
            <div class="checkbox-group">
                <input type="checkbox" name="termos" id="termos" required>
                <label for="termos" class="text-secondary">
            ...
            <button type="submit" class="btn-primary w-full" style="margin-top: 12px; height: 48px; font-size: 16px;">
